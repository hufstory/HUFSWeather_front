    ...
    <div className="container mt-[27px]">
      <div className="bg-white shadow-default rounded-today mx-5 text-[16px] leading-6 text-black justify-start items-center">
        <div className="flex py-2 pl-4">
          ...
          <div className="pl-2 text-base font-GmarketSansMedium">Why?</div>
        </div>
        ...
        <div className="pb-4 pl-4  text-base font-GmarketSansLight">
          ...
          <br></br>
          저희 외상청은{" "}
          <span className="text-rose-600 font-GmarketSansMedium">
            캠퍼스 내의 날씨
          </span>
          를 제공하고,{" "}
          <span className="text-rose-600 font-GmarketSansMedium">추천코디</span>를
